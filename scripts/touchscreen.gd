...
func _ready():
	...
	get_node("fire").set_scale(Vector2(get_node("left 2").get_viewport_rect().size.x/600,get_node("left 2").get_viewport_rect().size.x/600))
	get_node("fire").set_pos(Vector2(get_node("left 2").get_viewport_rect().size.x-200*get_node("left 2").get_viewport_rect().size.x/600,get_node("left 2").get_viewport_rect().size.y))
